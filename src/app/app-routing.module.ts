...
const routes: Routes = [
  ...
  { path: 'keuken/recepten', component: RecipesComponent},
  { path: 'keuken/recepten/nieuw', component: RecipeFormComponent},
  { path: 'keuken/recepten/:id', component: RecipeDetailComponent},
